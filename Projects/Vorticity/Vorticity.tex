...
\lstinputlisting[language=Python, label=FFT Example 1, caption=fft.py, style=FormattedNumber]{fft_example_1.py}
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.5]{Figures/fft_example_1}
\end{center}
\caption{Hello}
...
\lstinputlisting[language=Python, label=FFT Example 1, caption=fft.py, style=FormattedNumber]{fft_example_2.py}
%\lstinputlisting[language=Python, caption=format, firstline=1, lastline=10,style=FormattedNumber]{fft_example_1.py} 
%\section{Physics}
